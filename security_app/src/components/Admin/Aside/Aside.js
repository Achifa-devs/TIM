    ...
    <>
      <div className='aside'>
        ...
        <section>
          ...
          <ul>
            <li onClick={e=>window.location.href='/admin/'}>
              <span>
            ...
            <li onClick={e=>window.location.href='/admin/users'}>
              <span>
            ...
            <li onClick={e=>window.location.href='/admin/shift'}>
              <span>
            ...
            <li onClick={e=>window.location.href='/admin/inbox'}>
              <span>
          ...
          <ul>
            <li onClick={e=>window.location.href='/admin/settings'}>
              <span>
              ...
              <span>Sett</span>
            ings</li>
            <li onClick={e=>window.location.href='/admin/profile'}>
              <span>
