    ...
    let Registration = async(e) => {
        ...
        if(validation.current){
            ...
            try {
                ...
                axios.post('http://localhost:8888/api/v1/admin-registration', 
        ...
        <>
            ...
            <div className='form' action="" >
                ...
                <section className='first-child'>
                    ...
                    <h6 className="" style={{padding:'10px', margin: '0', height: 'auto', justifyContent: 'center', width: '100%', background: '#fff', fontWeight: '600', display: 'flex', alignItems: 'center', cursor: 'pointer'}} onClick={e=> window.location.href="/admin/login"}>Already Registered? Login Here.</h6>
                </section>
            </div>
