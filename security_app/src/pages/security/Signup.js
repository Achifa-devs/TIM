    ...
    let Registration = async(e) => {
        ...
        if(validation.current){
            ...
            try {
                ...
                axios.post('http://localhost:8888/security-registration', {fname,lname,email,phone,pwd})
                .then((response) => {
            ...
            <div className='form' action="" >
                ...
                <section className='first-child'>
                    ...
                    <div >
                        ...
                        <div className="input-cnt">
                            <input name='email' className='email' onInput={e=> setEmail(e.target.value)} type="text" placeholder="Email" />
                        </div>
                        <div className="input-cnt">
                            <input name='phone' className='phone' minLength={11} maxLength={11} onInput={e=> setPhone(e.target.value)} type="tel" placeholder="Phone Number" />
                        </div>
                    ...
                    <h6 className="" style={{padding:'10px', margin: '0', height: 'auto', justifyContent: 'center', width: '100%', background: '#fff', fontWeight: '600', display: 'flex', alignItems: 'center', cursor: 'pointer'}} onClick={e=> window.location.href="/login"}>Already Registered? Login Here.</h6>
                </section>
            </div>
